...
public class ItemController extends HttpServlet {
    ...
    private void deleteItem(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // Prevent deleting if item has details
    ...
    private void getItemDetail(HttpServletRequest request, HttpServletResponse response)
        ...
        if (detail != null) {
            ...
            response.getWriter().write("Item Detail not found!");
        }
    }
    ...
    private void updateItemDetail(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ItemDetail detail = new ItemDetail(detailId, null, description, manufacturer, warranty);
        getItemService().updateItemDetail(detail);
