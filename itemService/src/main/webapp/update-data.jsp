...
<body>
  <div class="card" role="region" aria-labelledby="form-title">
    ...
    <form action="/itemService/ItemController" method="post" novalidate>
      <div class="grid">

        <div class="field">
          <label for="name">Name</label>
          <input id="name" name="name" type="text"  value="${item1.name}"/>
        </div>

        <div class="field">
          <label for="price">Price</label>
          <input id="price" name="price" type="number"  value="${item1.price}"/>
          <div class="hint">Use decimals if needed</div>
        </div>

        <div class="field">
          <label for="totalNumber">Total Number</label>
          <input id="totalNumber" name="total" type="number" value="${item1.total}"/>
        </div>
      </div>
